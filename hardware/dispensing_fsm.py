...
class DispenseFSM:
    ...
    def __init__(self):
        ...
        self.machine.add_transition(
            trigger="start_activation", source="init", dest="activating"
        )
        self.machine.add_transition(
            trigger="verify_dispense", source="activating", dest="verifying"
        )
        self.machine.add_transition(
            trigger="complete_dispense", source="verifying", dest="completed"
        )
